...
def test_expected_column_type_after_insert_into_table_open_parenthesis_column_name(parser):
...
def test_expected_close_parenthesis_after_insert_into_table_open_parenthesis_column_name_close_parenthesis_values_open_parenthesis_value(parser):
